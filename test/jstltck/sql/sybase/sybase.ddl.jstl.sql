...
create table jstl_tab2(idNum INT NOT NULL, dob DATETIME NOT NULL, firstName VARCHAR(20) NOT NULL, lastName VARCHAR(20) NOT NULL, rank INT NOT NULL, rating NUMERIC(10,2) NULL) !

drop table jstl_tab3 !
create table jstl_tab3(idNum INTEGER NOT NULL, aDate DATETIME NULL, aTime DATETIME NULL, aTimestamp DATETIME NULL) !
