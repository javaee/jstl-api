...
/*
 * $Id: WebTestCase.java 56040 2008-10-15 16:16:13Z djiao $
 */
 ...
 * This allows the user to set criteria for test success
 * which will be compared against the response from the
 * server.
 */
public class WebTestCase implements TestCase {
    ...
    public static final String WHITESPACE_STRATEGY =
        "com.sun.ts.tests.common.webclient.validation.WhitespaceValidator";
    ...
    /**
     * A List of case insensitive strings that will be searched for in the response in the order
     * they appear in the list.
     */
     ...
     * attention paid to the order they appear.
     */
    ...
    /**
     * Strategy to use when validating the test case against the
     * server's response.
     */
    ...
    /**
     * Creates a new instance of WebTestCase
     * By default, a new WebTestCase instance
     * will use the TokenizedValidator to verify
     * the response with the configured properties
     * of the test case.
     */
    public WebTestCase() {
 ...
 */
     ...
     * @throws IllegalStateException if no request was configured
     *         or if no Validator is available at runtime.
     */
    ...
    /**
     * Sets the status code to be expected in the response from the server,
     * i.e. 500 or 404, etc.
     *
    ...
    /**
     * Sets a string that will be scanned for and expected
     * in the response body from the server.
     *
     * If multiple search strings are required, one can
     * either call this method for each string, or pass in
     * one string with pipe <code>|<code> delimiting the
     * individual search strings within the large string.
     *
     * @param searchString a string expected in the server's response
     *        body
     */
     ...
     * individual search strings within the large string.
     *
     * @param searchString a case insensitive string expected in the server's response
     *        body
     */
    ...
    /**
     * Sets a string that will be scanned for and should not be present
     * in the response body from the server.
     *
     * If multiple search strings are required, one can
     * either call this method for each string, or pass in
     ...
     * individual search strings within the large string.
     *
     * @param searchString a string that is not expected in the server's
     *        response body
     */
    ...
    /**
     * Sets a string  or series of strings that will be searched for
     * in the response.
     * If multiple search strings are required, one can
     * either call this method for each string, or pass in
     * one string with pipe <code>|<code> delimiting the
    ...
    /**
     * Returns an array of Header objects that are
     * expected to be found in the responst.
     *
    ...
    /**
     * Returns an array of Header objects that are
     * not expected to be found in the responst.
     *
     * @return an array of headers
     */
    ...
    /**
     * Returns the reason phrase that is expected to be found in the
     * server's response.
     *
    ...
    /**
     * Returns the configured list of strings that will be used when scanning
     * the server's response.
     *
    ...
    /**
     * Returns the configured list of strings that will be used when scanning
     * the server's response (these strings are not expected in the response).
     *
     * @return list of Strings
     */
     ...
     *
     * @param validator - the fully qualified class name of the
     *                    response validator to use.
     */
 ...
 */
     ...
     * @param headerString String representation of a header in the form of
     *        <headername>:<value>
     */
