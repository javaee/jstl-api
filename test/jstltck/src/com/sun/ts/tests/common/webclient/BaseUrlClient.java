...
/*
 * $Id: BaseUrlClient.java 56040 2008-10-15 16:16:13Z djiao $
 */
...
/**
 * <PRE>Provides base test initialization and runtime
...
public abstract class BaseUrlClient extends EETest {
     ...
     */
    protected static final String UNORDERED_SEARCH_STRING =
     ...
     */
    protected static final String UNEXPECTED_RESPONSE_MATCH =
    ...
    /**
     * HttpState that may be used for multiple invocations requiring
     * state.
     */
 ...
 */
    ...
    /**
     * <code>setup</code> is by the test harness to initialize
     * the tests.
     *
    ...
    public void setup(String[] args, Properties p) throws Fault {
        ...
        if (!isNullOrEmpty(hostname)) {
            ...
            throw new Fault("[BaseUrlClient] 'webServerHost' was not set in the" +
                " build.properties.");
        }
        ...
        if (!isNullOrEmpty(portnum)) {
            ...
            throw new Fault("[BaseUrlClient] 'webServerPort' was not set in the" +
                " build.properties.");
        }
        ...
        if (!isNullOrEmpty(tshome)) {
            ...
            throw new Fault("[BaseUrlClient] 'tshome' was not set in the " +
                "build.properties.");
        }
 ...
 */
    ...
    /** <PRE>Invokes a test based on the properties
     * stored in TEST_PROPS.  Once the test has completed,
     * the properties in TEST_PROPS will be cleared.</PRE>
    ...
    /** <PRE>Sets the appropriate test properties based
     * on the values stored in TEST_PROPS</PRE>
     */
    protected void setTestProperties(WebTestCase testCase) {
        ...
        for (Enumeration e = TEST_PROPS.propertyNames(); e.hasMoreElements();) {
            ...
            if (key.equals(STATUS_CODE)) {
                ...
                _redirect = true;
            } else if (key.equals(BASIC_AUTH_USER)
                || key.equals(BASIC_AUTH_PASSWD)
                ...
                req.setAuthenticationCredentials(user,
                    password, HttpRequest.BASIC_AUTHENTICATION, realm);
            }
        }
    }
