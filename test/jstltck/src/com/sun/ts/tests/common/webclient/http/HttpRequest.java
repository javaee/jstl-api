...
/*
 * $Id: HttpRequest.java 52684 2007-02-12 04:30:10Z lschwenk $
 */
...
public class HttpRequest {
     ...
     * The request line provied must be in the form of:<br>
     * <pre>
 ...
 */
    ...
    /**
     * <code>getRequestPath</code> returns the request path for
    ...
    /**
     * <code>getRequestMethod</code> returns the request type,
     * i.e., GET, POST, etc.
     *
    ...
    /**
     * <code>isSecureConnection()</code> indicates if the Request is
     * secure or not.
     *
    ...
    /**
     * <code>setSecureRequest</code> configures this request
     * to use SSL.
     *
    ...
    /**
     * <code>setContent</code> will set the body for this request.
     * Note, this is only valid for POST and PUT operations, however,
     * if called and the request represents some other HTTP method,
     * it will be no-op'd.
     *
    ...
    public void setContent(String content) {
        if (_method instanceof EntityEnclosingMethod) {
            ((EntityEnclosingMethod) _method).setRequestEntity(
     ...
     *
     * <p><code>username</code> and <code>password</code> cannot be
     * null.</p>
     *
     * <p>It is legal for <code>realm</code> to be null.</p>
     *
    ...
    public void setAuthenticationCredentials(String username, String password,
        ...
        TestUtil.logTrace("[HttpRequest] Added credentials for '" + username +
            "' with password '" + password + "' in realm '" +
            realm + "'");
    ...
    /**
     * <code>addRequestHeader</code> adds a request header to this request.
     * If a request header of the same name already exists, the new value,
     * will be added to the set of already existing values.
     *
    ...
    /**
     * <code>setFollowRedirects</code> indicates whether HTTP redirects
     * are followed.  By default, redirects are not followed.
     */
    ...
    /**
     * <code>getFollowRedirects</code> indicates whether HTTP redirects
     * are followed.  
     */
    ...
    /**
     * <code>setState</code> will set the HTTP state for the current
     * request (i.e. session tracking).  This has the side affect
     */
    ...
    /**
     * <code>execute</code> will dispatch the current request to the
     * target server.
     *
    ...
    public HttpResponse execute() throws IOException, HttpException {
        ...
        if ( _method.getFollowRedirects() ) { 
            ...
            TestUtil.logMsg("[HttpRequest] Dispatching request: '" +
                        _requestLine + "' to target server at '" + _host +
                        ":" + _port + "'");
 ...
 */
    ...
    /**
     * Adds any support request headers necessary for this request.
     * These headers will be added based on the state of the request.
     */
        ...
        switch (_authType) {
            ...
            case DIGEST_AUTHENTICATION:
                throw new UnsupportedOperationException(
                    "Digest Authentication is not currently " +
                    "supported");
        }
    ...
    /**
     * Sets a basic authentication header in the request is
     * Request is configured to use basic authentication
     */
    private void setBasicAuthorizationHeader() {
        UsernamePasswordCredentials cred = (UsernamePasswordCredentials)
            getState().getCredentials(new AuthScope(_host, _port, null));
    ...
    /**
     * Sets a host header in the request.  If the configured host
     * value is an IP address, the Host header will be sent, but without
     * any value.
     *
     * If we adhered to the HTTP/1.1 spec, the Host header must
     * be empty of the target server is identified via IP address.
     * However, no user agents I've tested follow this.  And if
     * a custom client library does this, it may not work properly
     * with the target server.
     * For now, the Host request-header will always have a value.
     */
