...
/*
 * $Id: HttpResponse.java 52770 2007-02-21 20:57:23Z djiao $
 */
...
public class HttpResponse {
    ...
    /**
     * The response body.  Initialized after first call
     * to one of the getResponseBody methods and cached
 ...
 */
     ...
     *
     * @return a specfic response header or null if the specified
    ...
    /**
     * Returns the response body as a byte array using the charset
     * specified in the server's response.
     *
    ...
    /**
     * Returns the response as bytes (no encoding is performed by
     * client.
    ...
    /**
     * Returns the response body as a string using the charset
     * specified in the server's response.
     *
    ...
    /**
     * Returns the response body of the server without being encoding
     * by the client.
    ...
    /**
     * Returns the response body as an InputStream using the encoding
     * specified in the server's response.
     *
    ...
    /**
     * Returns the response body as an InputStream without any encoding
    ...
    public String toString() {
        ...
        sb.append(((HttpMethodBase) _method).
            getParams().getVersion().equals(HttpVersion.HTTP_1_1) ?
               "HTTP/1.1 " : "HTTP/1.0 ");
    ...
    private String getEncodedResponse() throws IOException {
        if (_responseBody == null) {
            _responseBody = Util.getEncodedStringFromStream(
                                             _method.getResponseBodyAsStream(),
                                             getResponseEncoding());
        }
