 ...
 */
     ...
     *                true or false, depending on whether the provided substring
     *                is found in the provided string value.
     */
     ...
     * @test_Strategy: Validate that true is returned when both the 'string'
     *                 and 'substring' arguments are equal.
     */
     ...
     * @test_Strategy: Validate that false is returned if the 'string' argument
     ...
     * @test_Strategy: Validate the containsIgnoreCase function returns the proper value,
     *                true or false, depending on whether the provided substring
     *                is found in the provided string value.
     */
     ...
     *                 and 'substring' arguments are equal.
     */
    public void functionsContainsIgnoreCaseStringSubstringEqualTest() throws Fault {
        TEST_PROPS.setProperty(REQUEST,
     ...
     * @assertion_ids: JSTL:SPEC:79.1.1; JSTL:SPEC:79.2
     ...
     * @assertion_ids: JSTL:SPEC:79.1.3; JSTL:SPEC:79.4
     ...
     *                 for the following:
     *                       Arrays, Collections, Iterator, Enumeration, Map and Strings
     *
     */
     ...
     * @test_Strategy: Validate that if a null input value is provided to length(index)
     ...
     * @test_Strategy: Validate that if a an empty string is provided as input
     *                 to the length(input) function, 0 is returned.
     */
     ...
     * @test_Strategy: Validate that startsWith returns the expected values
     ...
     * @test_Strategy: Validate that true is returned if the prefix provided
     *                 is null.
     */
     ...
     * @test_Strategy: Validate that false is returned if the input string provided
     *                 is null.
     */
     ...
     * @test_Strategy: Validate that true is returned when the prefix is an
     *                 empty String.
     */
     ...
     * @test_Strategy: Validate that true is returned when the input string
     *                 and the prefix are equal.
     */
     ...
     * @test_Strategy: Validate that endsWith returns the expected values
     *                 based on the input values.
     */
     ...
     * @test_Strategy: Validate that true is returned if the suffix provided
     *                 is null.
     */
     ...
     * @test_Strategy: Validate that true is returned when the suffix is an
     *                 empty String.
     */
     ...
     * @test_Strategy: Validate that if a null string is provided to the substring()
     ...
     *                 of the input string will be 'adjusted' to be the length of
     *                 the string.
     */
     ...
     * @test_Strategy: Validate an emtpy string is returned when the
     *                 begin index is greater than the last index of the string.
     */
     ...
     * @test_Strategy: Validate that an end index that is less than the begin index
     *                 results in the function returning an emtpy string.
     */
     ...
     * @test_Strategy: Validate the proper behavior of substringBefore() with valid
     *                 input values(when the substring is found and when it is not).
     */
     ...
     * @test_Strategy: Validate the toLowerCase function will lower case
     ...
     * @test_Strategy: Validate the toUpperCase function will lower case
     *                 the provided input string.
     */
     ...
     * @test_Strategy: Validate the behavior of the trim function.  Leading
     *                 and trailing whitespace must be removed from the result.
     */
     ...
     * @test_Strategy: Validate an empty string is returned if the input string
     *                 is empty.
     */
     ...
     *                 JSTL:SPEC:81.2
     * @test_Strategy: Validate the join(String[], String) function properly
     *                 joins the elements of the String array using the
     *                 specified separator.
     */
     ...
     * @test_Strategy: Validate an empty string is returned in the case a
     *                 null value is provided to the array argument.
     */
     ...
     * @test_Strategy: Validate no separator is used if the value provided
     *                 to the separator argument is null.
     */
     ...
     * @test_Strategy: Validate no separator is used if the value provided
     *                 to the separator argument is an empty String.
     */
     ...
     * @test_Strategy: Validate the replace function the following:
     *                   - if the beforeString is found in the input string,
     *                     all occurances of the beforeString will be replaced
     *                     with the afterString.
     *                   - if the beforeString is not found, the inputString is
     *                     returned.
     */
     ...
     * @test_Strategy: Validate an empty String is returned by the replace function
     *                 if a null inputString is provided.
     */
     ...
     * @test_Strategy: Validate an empty String is returned by the replace function
     *                 if an empty inputString is provided.
     */
     ...
     * @test_Strategy: Validate the inputString is returned if the beforeString
     *                 is null.
     */
     ...
     * @test_Strategy: Validate all occurrences of beforeString are removed
     *                 from the inputString if the afterString value is null.
     */
     ...
     * @test_Strategy: Validate all occurrences of beforeString are removed
     *                 from the inputString if the afterString value is an
     *                 empty string.
     */
     ...
     *                 from an input string with a designated delimiter.  The
     *                 delimiter will not appear in any of the tokens returned.
     */
     ...
     * @test_Strategy: Validate an array consisting of a single element with
     *                 an empty string as that element's value is returned
     *                 if the inputString is null.
     */
     ...
     * @test_Strategy: Validate an array consisting of a single element with
     *                 the inputString as that element's value is returned if
     *                 the delimiter specified is null.
     */
     ...
     * @test_Strategy: Validate an array consisting of a single element with
     *                 the inputString as that element's value is returned if
     *                 the delimiter specified is empty.
     */
