...
/*
 * $URL: http://jse.east.sun.com:9001/re_repos/spider/branches/jstl/1.2/src/com/sun/ts/tests/jstl/spec/fmt/format/localecontext/JSTLClient.java $ $LastChangedDate: 2007-08-16 17:44:19 -0400 (Thu, 16 Aug 2007) $
 */
 ...
 */
     ...
     *                action, the formatting action will use the locale
     *                of the parent action.  This will be verified by
     *                Setting the javax.servlet.jsp.jstl.fmt.localizationContext scoped
     *                variable.  The basename attribute will refer to an
     *                fr_FR bundle. The fmt:setBundle action that
     *                encloses a formatting action will have a single en_US
     *                resource bundle, so the resulting locale will be en_US.
     *                If the action chooses the proper locale,
     *                no parse exception will occur.
     */
     ...
     *                will take precedence over the javax.servlet.jsp.jstl.fmt.locale
     *                scoped attribute.  This will be verified by setting the
     ...
     * @testStrategy:  If the javax.servlet.jsp.jstl.fmt.locale attribute is
     *                 set, the locale specified by this attribute will be used
     *                 vs. those provided by the browser (i.e. preferred locales
     *                 from an Accept-Language header).  This will be verified by
     *                 setting the locale attribute to en_US and the client's
     *                 preferred locale to de_DE.  If the locale attribute is
     *                 used, no parse exception will occur.
     */
     ...
     *                javax.servlet.jsp.jstl.fmt.locale attributes set, the formatting
     *                locale will be based on the preferred locales provided by
     *                the client (via the Accept-Language request header).
     */
