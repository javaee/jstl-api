...
/*
 * $URL: http://jse.east.sun.com:9001/re_repos/spider/branches/jstl/1.2/src/com/sun/ts/tests/jstl/spec/fmt/format/fmtdate/JSTLClient.java $ $LastChangedDate: 2007-08-10 20:14:33 -0400 (Fri, 10 Aug 2007) $
 */
 ...
 */
     ...
     *                 JSTL:SPEC:57.22
     * @testStrategy: Validate that formatDate action can properly format
     *                dates provided as String literals or as java.util.Date
     *                objects.
     */
     ...
     *                - If type is not specified, only the date will be formatted.
     *                - The value is properly formatted when explicity using
     *                  time, date, or both.
     */
     ...
     *                - If dateStyle is not present, the default value for
     *                  dateStyle, default, will be applied when type is not
     *                  specified, or is set to date or both.
     */
     ...
     *                - If timeStyle is not present, the default value for
     *                  timeStyle, default, will be applied when type is
     *                  set to time or both.
     */
     ...
     *                applied to the date value provided.
     */
     ...
     *                accept String literals representing a time zone,
     ...
     * @assertion_ids: JSTL:SPEC:57.6; JSTL:SPEC:57.6.1
     * @testStrategy: Validate that the if var is specified, the formatted
     *                value is not written to the current JspWriter, but is
     *                instead availabe via the PageContext and is of type
     *                String (validation performed via custom action).
     */
     ...
     *                 JSTL:SPEC:57.8.2; JSTL:SPEC:57.8.3; JSTL:SPEC:57.8.4; 
     *                 JSTL:SPEC:57.8.5
     ...
     * @testStrategy: Validate that if value is null and var, or scope
     *                and var is specified, the scoped variable referenced
     *                by var is removed.  If var, or scope and var is not
     ...
     *                value will be formatted as if it was present.
     ...
     * @assertion_ids: JSTL:SPEC:57.6; JSTL:SPEC:57.6.15; JSTL:SPEC:57.6.16
