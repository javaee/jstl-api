 ...
 */
     ...
     *                 JSTL:SPEC:93.1.2; JSTL:SPEC:93.1.3; JSTL:SPEC:93.1.4; 
     *                 JSTL:SPEC:93.1.5; JSTL:SPEC:93.1.7
     * @testStrategy: Validate that the value attribute can accept 
     *                dynamic values as well as three letter timezones (ex.
     ...
     *                is properly set and associated with the variable name
     *                specified by var.
     */
     ...
     *                attribute, var is exported to the appropriate scope.
     *                Additionally, validate that if var is specified and
     *                scope is not, that var is exported to the page scope
     *                by default.
     */
     ...
     * @testStrategy: Validate that if the value attribute is null or empty,
     ...
     * @testStrategy: Validate that if var is not set, the scoped
     ...
     *                 JSTL:SPEC:93.3.3; JSTL:SPEC:93.3.4; JSTL:SPEC:93.3.5;
     *                 JSTL:SPEC:93.4
     * @testStrategy: Validate that if var is not specified, but scope
     *                is, that the scoped variable,
     *                javax.servlet.jsp.jstl.fmt.timeZone is exported
