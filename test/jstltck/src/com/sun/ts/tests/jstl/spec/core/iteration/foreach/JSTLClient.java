...
/*
 * $URL: http://jse.east.sun.com:9001/re_repos/spider/branches/jstl/1.2/src/com/sun/ts/tests/jstl/spec/core/iteration/foreach/JSTLClient.java $ $LastChangedDate: 2007-07-02 16:00:41 -0400 (Mon, 02 Jul 2007) $
 */
 ...
 */
     ...
     * @testStrategy: Validated the behavior of the 'var' attribute.
     *                 - the type should be the type of the object
     *                   in the underlying collection.
     *                 - the exported var has nested visibility meaning
     *                   if the variable name reference by var, previously
     *                   existed, it should no longer exist after completion
     *                   of the action.
     */
     ...
     * @testStrategy: Validate that arrays of all primitive
     *                types can be handled by 'forEach' and that
     *                the values in the underlying array are wrapped
     *                with its corresponding wrapper type.
     */
     ...
     * @testStrategy: Validate that 'forEach' can handle various
     *                Collection objects.
     */
     ...
     * @testStrategy: Validate that 'forEach' can handle a comma-separated
     *                string
     */
     ...
     *                 - Both EL and RT actions' 'begin' attribute
     *                   accept dynamic and static attribute values
     *                 - Behavior of the action when the 'begin' attribute
     *                   is specified
     */
     ...
     * @testStrategy: Validate the following:
     *                 - Both EL and RT actions' 'end' attribute
     *                   accept dynamic and static attribute values
     *                 - Behavior of the action when the 'end' attribute
     *                   is specified
     */
     ...
     * @testStrategy: Validate the following:
     *                 - Both EL and RT actions' 'step' attribute
     *                   accept dynamic and static attribute values
     *                 - Behavior of the action when the 'step' attribute
     *                   is specified
     */
     ...
     * @testStrategy: Validate that varStatus is properly exported with
     *                nested scope and is of type javax.servlet.jsp.jstl.
     *                LoopTagStatus.
     */
     ...
     * @testStrategy: Validate tag behavior when no 'items' attribute
     *                is specified.
     */
     ...
     * @testStrategy: Validate that the 'forEach' action can handle
     *                body content as well as an empty body.
     */
     ...
     * @testStrategy: Validate that no iteration is performed by forEach
     *                if items is null.
     */
     ...
     * @testStrategy: Validate that a javax.servlet.jsp.JspException
     *                is thrown if the EL expression passed to items evaluates
     ...
     * @testStrategy: Validate that a javax.servlet.jsp.JspException
     *                is thrown if the EL expression passed to begin evaluates
     *                to an incorrect type.
     */
     ...
     * @testStrategy: Validate that a javax.servlet.jsp.JspException
     *                is thrown if the EL expression passed to end evaluates
     *                to an incorrect type.
     */
     ...
     * @testStrategy: Validate that a javax.servlet.jsp.JspException
     *                is thrown if the EL expression passed to step evaluates
     *                to an incorrect type.
     */
     ...
     * @testStrategy: Validate that an exception caused by the body content
     *                is propagated.
     */
     ...
     *                 the Vector as a deferred value in the items attribute.
     *                 In the body of the tag, set each item to have application
     *                 scope. Verify that the items can be retrieved after the
     ...
     * @assertion_ids: JSTL:SPEC:21.14
     * @test_Strategy: Create a String containing several items delimited by spaces. 
     *                 In a c:forEach tag, reference the String as a deferred value 
     ...
     * @assertion_ids: JSTL:SPEC:21.14
     * @test_Strategy: Create a HashMap containing several items. 
     *                 In a c:forEach tag, reference the HashMap as a deferred value 
     *                 in the items attribute.  In the body of the tag, set each 
     *                 item to have application scope. Verify that the items can be 
     *                 retrieved after the execution of the tag.
     */
