...
/*
 * $URL: http://jse.east.sun.com:9001/re_repos/spider/branches/jstl/1.2/src/com/sun/ts/tests/jstl/spec/sql/setdatasource/JSTLClient.java $ $LastChangedDate: 2007-02-11 23:30:10 -0500 (Sun, 11 Feb 2007) $
 */
 ...
 */
     ...
     *                a dataSource attribute to sql:setDataSource which contains
     *                JDBC DriverManager properties (URL, driver, user, password)
    ...
    public void positiveSetDataSourceUpdateURLTest() throws Fault {
        TEST_PROPS.setProperty(STANDARD,
            "positiveSetDataSourceUpdateURLTest");
        invoke();
    }
     ...
     * @assertion_ids:
     * @testStrategy: Validate sql:setDataSource and sql:transaction actions specifying
     *                a dataSource attribute to sql:setDataSource which contains
     *                JDBC DriverManager properties (URL, driver, user, password)
     *                The query is passed as body content.
     */
    ...
    public void positiveSetDataSourceTxDataSourceTest() throws Fault {
        TEST_PROPS.setProperty(STANDARD,
            "positiveSetDataSourceTxDataSourceTest");
        invoke();
    }
     ...
     *                specifying sql:setDataSource the attributes: url,
     *                driver, user and password. The query is passed as
     *                body content.
     */
    public void positiveSetDataSourceTxURLTest() throws Fault {
        TEST_PROPS.setProperty(STANDARD,
            "positiveSetDataSourceTxURLTest");
        invoke();
    }
     ...
     * @assertion_ids:
     * @testStrategy: Validate sql:setDataSource and sql:query actions by
     *                setting javax.servlet.jsp.jstl.sql.dataSource to
     *                JDBC DriverManager properties (URL, driver, user, password)
     *                The query is passed as body content.
     */
     ...
     * @assertion_ids:
     * @testStrategy: Validate sql:setDataSource and sql:update actions by
     *                setting javax.servlet.jsp.jstl.sql.dataSource to
     *                JDBC DriverManager properties (URL, driver, user, password)
     *                The query is passed as body content.
     */
     ...
     * @assertion_ids:
     * @testStrategy: Validate that if a sql:setDataSource action utilizes the scope
    ...
    /*
      ...
      * @assertion_ids:
      * @testStrategy: Validate the sql:setDataSource action which specifies a
      *                null for the dataSource attribute will generate a
      *                JspException.
      */
  ...
  * @assertion_ids:
  * @testStrategy: Validate the sql:setDataSource action which specifies an DataSource
  *                Object which is uninitialized for the dataSource attribute
  *                will generate a JspException the first attempt to use it.
  */
