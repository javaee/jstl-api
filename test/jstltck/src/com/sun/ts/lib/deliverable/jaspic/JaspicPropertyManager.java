...
public class JaspicPropertyManager extends AbstractPropertyManager {
     ...
     */
    public final static JaspicPropertyManager getJaspicPropertyManager(TestEnvironment env)
    ...
    /**
     * This method returns
     * the singleton instance of JaspicPropertyManager which provides access
     ...
     */
    public final static JaspicPropertyManager getJaspicPropertyManager(Properties p)
    throws PropertyNotSetException {
