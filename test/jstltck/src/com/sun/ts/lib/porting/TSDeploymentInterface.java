...
/*
 * $Id: TSDeploymentInterface.java 52502 2007-01-24 02:50:22Z lschwenk $
 */
...
/**
 * This is the TSDeploymentInterface.  An implementation of this interface must
 * be provided by each Java EE implementation, to support their own deploy/undeploy
 * semantics.
 *  
 * @author	Kyle Grucci
 */
public interface TSDeploymentInterface
{
	...
	/**
	 * This method is called by the test harness to deploy an .ear file into
	 * your Java EE implementation.  We extract such info as the app 
	 ...
	 * Java EE implementation.  We extract such info as host and app
	...
	/**
	 * This method is called to deploy a connector (.rar file) to your
	...
	/**
	 * This method is called to undeploy a connector (.rar file) from your
	 * Java EE implementation.  We extract such info as deployment_host 
	 * and rar_file from these props.  The following properties are available 
	 * for this method's use:  
	 * 
	...
	/**
	 * This method is called to check to see if a given connector (.rar file) 
	 * is deployed on your Java EE implementation.  We extract such info
	 * as deployment_host and rar_file from these props.  The following 
	 * properties are available for this method's use:  
	 * 
	 * rar_file - the fully qualified connector file (.rar file) 
	 * deployment_host - the host name of the machine to deploy it to 
	 ...
	 *
	 * @param	p	Properties specific to the currently running test
	 * @return		This method should return a string which represents all
	 *				executeArgs to be used.
	 */
	public String getAppClientArgs(Properties p);
	
	/**
	 * This method is called by the test harness to get the corba JNDI names
	 * to use in an interop scenario.  This method should return a hashtable
	 ...
	 *
	 * @param	infoArray	Array of DeploymentInfo objects for the ear files
	 *						associated with a particular directory
	 * @return	Hashtable	This method should return a Hashtable of mappings
	 *						(see above)
	 */
