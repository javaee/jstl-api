...
/*
 * $Id: DeploymentInfo.java 52502 2007-01-24 02:50:22Z lschwenk $
 */
 ...
 * Much of this information is extracted from runtime xml files.  The following
 * information is provided:
 * <ul>
 * <li>EJB Jar info</li>
 * <li>Web Resources - Display name, context root, resource references
 * and ejb references for each web resource in this ear.</li>
 * <li>EJB Resources - Name, JNDI name, resource references, ejb
 * references, and CMP information for each ejb resource in this ear.</li>
 * <li>Resource References - For each resource reference, the
 * JNDI name, default resource principal name and password, and any mail
 * configuration information is provided.</li>
 * <li>EJB References - For each EJB reference, the EJB name and its
 * corresponding JNDI name is provided.</li>
 * </ul>
 * </p>
 * See:
 *    javaee.home.ri/lib/dtds/sun-application_5_0-0.dtd
 *    javaee.home.ri/lib/dtds/sun-application-client_5_0-0.dtd
 *    javaee.home.ri/lib/dtds/sun-ejb-jar_3_0-0.dtd
 *    javaee.home.ri/lib/dtds/sun-web-app_2_5-0.dtd
...
{
    /**
     * Sets the value of the given property.  This method should be
     * temporary, until all important information can be provided by the API.
     */
    public void setProperty(String key, String value); 

    /**
     * Returns the value of the given property.  This method should be
     * temporary, until all important information can be provided by the API.
     */
    public String getProperty(String key); 

    /**
     * Sets/gets an array of deploymentInfo objects from previously
     * deployed apps in the currrent directory along with all common apps
     */
