...
<tck:test testName="positiveDateParamQueryNoTypeTest">
   ...
   <!-- Validate sql:query, sql:dateParam actions without specifying the type
       attribute defaults to timestamp -->

   <h1> Validate sql:query, sql:dateParam actions without specifying the type
