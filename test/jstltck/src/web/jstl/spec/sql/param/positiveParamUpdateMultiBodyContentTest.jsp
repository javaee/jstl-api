...
<tck:test testName="positiveParamUpdateMultiBodyContentTest">
   ...
   <!-- Validate sql:update and sql:params actions allows for the
            execution of a SQL statement specifying  multiple parameters -->

   <h1>Validate  sql:update and sql:params actions allows for the execution
       of a SQL statement specifying  multiple parameters </h1>
   <p>
