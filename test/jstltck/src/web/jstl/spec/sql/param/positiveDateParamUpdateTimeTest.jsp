...
<tck:test testName="positiveDateParamUpdateTimeTest">
 ...
 <%
   ...
   <sql:update var="updateCount2"
                  ...
                  sql='<%=((Properties)pageContext.getAttribute("sqlProps",PageContext.APPLICATION_SCOPE)).getProperty("Insert_Jstl_Tab3_Time_Query") %>' >
   ...
   <c:choose>
       ...
       <c:otherwise>
          ...
          <c:out value="${sqlProps.Insert_Jstl_Tab3_Time_Query}" escapeXml='false'/>
 ...
 <sql:query var="resultSet2" dataSource="${applicationScope.jstlDS}"
              sql="${sqlProps.Select_Jstl_Tab3_Time_Query}" >
      <sql:dateParam value="${theDate}" type='time'/>
   </sql:query>
