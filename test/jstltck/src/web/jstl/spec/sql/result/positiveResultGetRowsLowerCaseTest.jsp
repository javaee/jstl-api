...
<tck:test testName="positiveResultGetRowsLowerCaseTest">
  ...
  <!-- Validate the access to Result.getRows via a column name is case
          insensitive testing using Lower Case -->

   <h1>Validate the access to Result.getRows via a column name is case
          insensitive testing using Lower Case via RT</h1>
   <p>
  ...
  <%-- Convert the column names to Lower Case to validate case insensitivity --%>
  <%
     String columns2 [] = (String[])pageContext.getAttribute("column2");
     pageContext.setAttribute("IDNUM2", columns2[0].toLowerCase());
     pageContext.setAttribute("FIRSTNAME2", columns2[1].toLowerCase());
     pageContext.setAttribute("LASTNAME2", columns2[2].toLowerCase());
