...
<tck:test testName="positiveSetDataSourceUpdateNoVarAttributeDataSourceTest">
   ...
   <p>
 <c:catch var="ex3"  >
      <sql:setDataSource dataSource='<%=(DataSource) pageContext.getAttribute("jstlDS", PageContext.APPLICATION_SCOPE) %>'
          />
  </c:catch>
